...
public final class BitcoinIntegration
{
	...
	{
		final StringBuilder uri = new StringBuilder("zetacoin:");
		if (address != null)
			uri.append(address);
		if (amount != null)
	...
	{
		Toast.makeText(context, "No Zetacoin application found.\nPlease install Zetacoin Wallet.", Toast.LENGTH_LONG).show();
